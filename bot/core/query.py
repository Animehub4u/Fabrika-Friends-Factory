            ...
            try:
                if check_base_url() is False:
                    if settings.ADVANCED_ANTI_DETECTION:
                        sys.exit(
                            "Detected index js file change. Contact me to check if it's safe to continue: https://t.me/airdropscriptzone")
                    else:
                        sys.exit(
                            "Detected api change! Stopped the bot for safety. Contact me here to update the bot: https://t.me/airdropscriptzone")
