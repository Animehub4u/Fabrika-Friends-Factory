...
## [Settings](https://github.com/Animehub4u/Fabrika-Friends-Factory/blob/main/.env-example)
...
## Installation
You can download the [**repository**](https://github.com/Animehub4u/Fabrika-Friends-Factory) by cloning it to your system and installing the necessary dependencies:
```shell
https://github.com/Animehub4u/Fabrika-Friends-Factory.git
...
> git clone https://github.com/Animehub4u/Fabrika-Friends-Factory.git
> cd Fabrika-Friends-Factory
> pip install -r requirements.txt
> python main.py
```
